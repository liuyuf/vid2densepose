...
def main(input_video_path="./sample_videos/input_video.mp4", output_video_path="./sample_videos/output_video.mp4"):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-i", "--input_video_path", type=str, default="./sample_videos/input_video.mp4"
    )
    parser.add_argument(
        "-o", "--output_video_path", type=str, default="./sample_videos/output_video.mp4"
    )
