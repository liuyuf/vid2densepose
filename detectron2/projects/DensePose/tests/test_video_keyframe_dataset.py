...
from detectron2.projects.DensePose.densepose.data.transform import ImageResizeTransform
from detectron2.projects.DensePose.densepose.data.video import RandomKFramesSelector, VideoKeyframeDataset
